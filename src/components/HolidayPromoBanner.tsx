  ...
  return (
    <AnimatePresence>
      {open && (
        <>
          {/*
            The panel is fixed and covers the right of the page, so a click on
            anything beneath it would otherwise be swallowed with no feedback.
            This backdrop turns that dead zone into a dismiss action.
          */}
          <motion.button
            key="holiday-banner-backdrop"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            ...
            className="fixed inset-x-0 bottom-0 z-20 cursor-pointer bg-black/25 backdrop-blur-[1px]"
          />
            ...
            <div className="flex w-full flex-1 flex-col overflow-y-auto">
              ...
              <div className="flex flex-1 flex-col px-7 pt-7 pb-8 sm:px-9">
                ...
                <p className="font-secondary mb-6 text-[13.5px] leading-relaxed text-gray-300">
                  ...
                  set a tone no ballroom can replicate, with full-service
