        ...
        >
          ...
          <div className="mb-10">
            <p className="leading-relaxed text-gray-700">
              ...
              Hospitality Group Inc. ("FiDi") or affiliate(s) thereof (referred
              to either as "Owner" or "we" or "us" or "our"), and provides the
              content, materials, and information contained on this website or
              any of the pages contained therein ("Website") to users or
              visitors (referred to either as "you" or "your") for your
              convenience, ease of reference, and personal use only.
            </p>
            <p className="mt-4 leading-relaxed text-gray-700">
              Your use of this Website is subject to the terms and conditions
              set forth herein, in Owner's privacy policy and cookies policy
              applicable to this Website (hereinafter collectively referred to
              as "TOUs"). FIDI reserves the right to update these TOUs at any
          ...
          <div className="mb-10">
            ...
            <p className="leading-relaxed text-gray-700">
              ...
              other proprietary information, the "look and feel" of each page,
              and all other elements of this Website that may be protected by
              copyright, patent or otherwise by law, equity, usage of trade, and
              similar ("Website Materials") is the exclusive property of Owner,
              its successors and assigns or its licensors. The compilation of
              all content included in or made available through this Website is
              the exclusive property of FIDI and protected by U.S. or
              international laws or both.
            </p>
            <p className="mt-4 leading-relaxed text-gray-700">
              The trademarks, names, brand names, logos, and service marks
              (collectively "Trademarks") displayed on this Website are the
              registered or unregistered trademarks of Owner, its successors and
              assigns, or its licensors. Nothing contained on this Website
              should be construed as granting any license or right to use any
              Trademark or Website Materials without the prior written
              permission of Owner.
            </p>
          </div>
          ...
          <div className="mb-10">
            ...
            <p className="leading-relaxed text-gray-700">
              ...
              "AS IS" and "AS AVAILABLE" basis. Owner makes no representations
              or warranties, express or implied, including implied warranties of
              merchantability or fitness for a particular purpose, title, and
              non-infringement regarding this Website or the Website Materials
            ...
            <p className="mt-4 leading-relaxed text-gray-700">
              ...
              materials or information (collectively "Malware"); (b) that this
              Website is free from defects and/or errors and that access to this
              Website will suffer no interruptions, outages etc.; and/or (c)
              that such errors and/or defects will be corrected. It being
              understood and agreed that in using this Website, you agreed to
          ...
          <div className="mb-10">
            ...
            <p className="leading-relaxed text-gray-700">
              ...
              (each an "External Site") which have no connection with this
              Website or Owner. A link to an External Site is provided solely
              for your convenience. The inclusion of any External Site does not
              imply that Owner has approved, checked, or otherwise endorsed any
              such External Site, its content, or any products or services which
              may be offered at any such External Sites, it being understood and
              agreed that External Sites are beyond the control of Owner, and
              Owner is not responsible for the contents of any External Site or
              any link contained in an External Site, or any changes or updates
              to such sites.
            </p>
            <p className="mt-4 leading-relaxed text-gray-700">
          ...
          <div className="mb-10">
            ...
            <p className="mt-4 leading-relaxed text-gray-700">
              ...
              SERVICES, FROM INABILITY TO USE THE OWNER'S GOODS OR SERVICES, OR
              FROM THE INTERRUPTION, SUSPENSION, OR TERMINATION OF THE OWNER'S
          ...
          <div className="mb-10">
            ...
            <p className="leading-relaxed text-gray-700">
              ...
              ("User Submissions") and the hosting, sharing, or publishing, or
              any combination thereof, of such User Submissions. You agree that,
              upon posting, submitting, or otherwise transmitting to Owner, any
              such User Submissions will become and forever be the property of
              Owner and you further understand that whether or not such User
              Submissions are published, Owner does not guarantee any
