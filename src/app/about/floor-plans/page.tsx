          ...
          >
            ...
            {/* <div className="flex w-full items-center justify-center">
              <div className="relative inline-block">
                ...
                <div className="bg-primary text-dark-black absolute -top-3 -right-3 rounded-full p-2 shadow-lg">
                  <svg
                ...
                <p className="text-primary font-secondary mt-2 animate-pulse text-sm font-semibold tracking-[0.3em] uppercase">
                  Coming Soon
                </p>
              </div>
            </div> */}
