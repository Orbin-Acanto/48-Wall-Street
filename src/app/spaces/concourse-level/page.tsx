...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: '/spaces/concourse-level/hero-1.jpg',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ['/spaces/concourse-level/hero-1.jpg'],
  },
};
...
export default function ConcourseLevelPage() {
  return (
    <SpaceDetails
      ...
      heroImages={[
        '/spaces/concourse-level/hero-1.jpg',
        '/spaces/concourse-level/hero-2.jpg',
        '/spaces/concourse-level/hero-3.jpg',
      ]}
      images={[
        '/spaces/concourse-level/gallery-1.jpg',
        '/spaces/concourse-level/gallery-2.jpg',
        '/spaces/concourse-level/gallery-3.jpg',
        '/spaces/concourse-level/gallery-4.jpg',
        '/spaces/concourse-level/gallery-5.jpg',
        '/spaces/concourse-level/gallery-6.jpg',
      ]}
      videoUrl="https://player.vimeo.com/video/192678532?h=c1ec68adce"
      floorPlanImage="/floor_planner/plan/concourse-vault.svg"
      features={[
