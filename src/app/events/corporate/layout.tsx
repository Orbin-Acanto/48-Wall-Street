...
export const metadata: Metadata = {
  title:
    'Corporate Event Venue Wall Street | Conference Space Financial District NYC ',
  description:
  ...
  openGraph: {
    ...
    images: [
      {
        url: '/gallery/corporate/corporate-01.jpg',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ['/gallery/corporate/corporate-01.jpg'],
  },
  alternates: {
