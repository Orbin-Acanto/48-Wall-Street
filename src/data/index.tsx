  ...
  sections: [
    {
      ...
      imageAlts: [
        ...
        'Luxury floral installation and tablescape at 48 Wall Street, Financial District',
        'Branded scenic environment designed for an event at 48 Wall Street',
        'Lounge furniture and decor styling at 48 Wall Street, Lower Manhattan',
        'Immersive event decor in the historic Banking Hall at 48 Wall Street',
      ],
    },
    {
      id: 'audio-visual',
      ...
      imageAlts: [
        'Audio visual production and LED screen setup at 48 Wall Street, NYC',
        'Conference AV and presentation technology at 48 Wall Street, Financial District',
        'Sound system and stage engineering at 48 Wall Street, Lower Manhattan',
        'Projection and video display in the Banking Hall at 48 Wall Street',
        'Live event AV control and technical direction at 48 Wall Street, NYC',
      ],
    },
    {
      id: 'lighting',
      ...
      imageAlts: [
        'Architectural event lighting in the Grand Mezzanine at 48 Wall Street, NYC',
        'Uplighting and color wash on historic columns at 48 Wall Street',
        'Custom gobo and logo projection at 48 Wall Street, Financial District',
        'Stage and scenic lighting design at 48 Wall Street, Lower Manhattan',
        'Dramatic event lighting beneath 30-foot ceilings at 48 Wall Street',
      ],
    },
    {
      id: 'staging',
      ...
      imageAlts: [
        'Custom stage build for a corporate presentation at 48 Wall Street, NYC',
        'Fashion show runway staging at 48 Wall Street, Financial District',
        'Branded stage set and backdrop at 48 Wall Street, Lower Manhattan',
        'Presentation platform and lectern staging at 48 Wall Street, NYC',
        'LED integrated staging in the Banking Hall at 48 Wall Street',
      ],
    },
    {
      ...
      imageAlts: [
        'Custom fabricated scenic element for a branded event at 48 Wall Street, NYC',
        'Large-format printed graphics and signage at 48 Wall Street, Financial District',
        'Branded step and repeat backdrop at 48 Wall Street, Lower Manhattan',
        'Custom built installation and dimensional display at 48 Wall Street',
      ],
    },
    {
      id: 'entertainment',
      ...
      imageAlts: [
        'Live band performance at an event in 48 Wall Street, Financial District NYC',
        'Specialty performer entertaining guests at 48 Wall Street, Lower Manhattan',
        'DJ and dance floor entertainment at 48 Wall Street, historic NYC venue',
      ],
    },
  ],
  ...
  sections: [
    {
      ...
      imageAlts: [
        'Luxury lounge furniture rental at 48 Wall Street, Financial District NYC',
        'Scenic decor and prop rentals at 48 Wall Street, Lower Manhattan',
        'Custom themed decor styling at 48 Wall Street, historic NYC venue',
      ],
    },
    {
      id: 'staging-rentals',
      ...
      imageAlts: [
        'Modular stage platform rental at 48 Wall Street, Financial District NYC',
        'Runway staging rental for fashion events at 48 Wall Street',
        'Custom stage decking and risers at 48 Wall Street, Lower Manhattan',
        'Keynote presentation staging at 48 Wall Street, historic NYC venue',
        'Performance stage setup at 48 Wall Street, Wall Street event space',
      ],
    },
    {
      id: 'catering-rentals',
      ...
      imageAlts: [
        'Catering rental china, flatware and stemware at 48 Wall Street, NYC',
        'Banquet table and linen rentals at 48 Wall Street, Financial District',
        'Bar and cocktail station rentals at 48 Wall Street, Lower Manhattan',
        'Catering service setup at 48 Wall Street, historic NYC event venue',
        'Dining furniture and place settings at 48 Wall Street, Wall Street NYC',
      ],
    },
  ],
};
