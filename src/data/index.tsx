  ...
  sections: [
    {
      ...
      subtitle: 'From Brand Vision to Real-World Experience.',
      description:
        'At MME Worldwide, we partner with leading brands and agencies to transform ambitious ideas into powerful physical experiences. Our custom fabrication capabilities bring brand strategy to life through experiential activations, product launches, trade shows, immersive environments, pop-ups, branded installations, and high-profile corporate experiences designed to command attention and deepen audience engagement.<br><br>From initial creative development through engineering, fabrication, logistics, installation, and execution, MME provides an integrated approach under one experienced production partner. Every environment is thoughtfully designed to reflect your brand identity, support your marketing objectives, and create meaningful moments between your brand and its audience.<br><br>Whether launching a global product, creating an immersive consumer activation, or developing a one-of-a-kind brand environment, MME Worldwide turns creative vision into experiences that engage, inspire, and leave a lasting brand impression.',
      closer: 'Your Vision. Our Craft. One Extraordinary Brand Experience.',
      images: [
      ...
      imageAlts: [
        'Custom fabrication display 1',
        'Custom fabrication display 2',
        'Custom fabrication display 3',
        'Custom fabrication display 4',
      ],
    },
    {
      id: 'large-format-printing',
      title: 'Large-Format Printing & Branded Graphics',
      subtitle: 'Make Your Brand Impossible to Miss.',
      description:
        'At MME Worldwide, our professional printing and graphic production services transform creative concepts into bold, high-impact brand experiences. From corporate events and product launches to experiential activations, trade shows, pop-ups, conferences, and retail environments, we produce premium visual solutions designed to command attention and reinforce your brand at every touchpoint.<br><br>Our capabilities include large-format printing, custom signage, dimensional graphics, step-and-repeats, branded backdrops, wall and window graphics, floor graphics, banners, custom decals, event branding, exhibition graphics, wayfinding, scenic graphics, and specialty printed installations.<br><br>From artwork preparation and production through fabrication, delivery, installation, and removal, MME Worldwide provides a seamless, end-to-end solution, ensuring exceptional quality, brand consistency, and flawless execution.<br><br>Whether creating a single statement piece or branding an entire environment, MME Worldwide turns every surface into an opportunity to tell your brand story.',
      closer: 'Print. Brand. Transform. Make an Impact.',
      images: [
        '/services/production/cf/gallery-03.jpg',
        '/services/production/cf/gallery-01.jpg',
        '/services/production/cf/gallery-02.jpg',
      ...
      imageAlts: [
        'Branded graphics display 1',
        'Branded graphics display 2',
        'Branded graphics display 3',
      ],
    },
    {
      id: 'audio-visual',
      title: 'Audio Visual & Event Technology',
      subtitle: 'Technology That Elevates the Experience.',
      description:
        'At MME Worldwide, we deliver sophisticated audio visual and event technology solutions designed to transform how audiences see, hear, and experience your brand. From executive conferences and corporate meetings to product launches, experiential activations, galas, fashion events, and large-scale productions, our AV specialists combine advanced technology with seamless execution.<br><br>Our capabilities include professional sound systems, LED video walls, projection and displays, presentation technology, stage and scenic lighting, intelligent lighting, microphones, digital content integration, live streaming, video conferencing, recording, show calling, technical direction, and on-site engineering support.<br><br>From initial technical planning and system design through installation, programming, rehearsals, live production, and strike, MME Worldwide provides an integrated approach with one objective: flawless performance at every moment that matters.<br><br>Whether connecting an executive team with a global audience, unveiling a new product, or producing an immersive brand experience, we design technology around your message, not the other way around.',
      closer:
      ...
      imageAlts: [
        'Audio visual display 1',
        'Audio visual display 2',
        'Audio visual display 3',
        'Audio visual display 4',
        'Audio visual display 5',
      ],
    },
    {
      id: 'lighting',
      title: 'Lighting Design & Production',
      subtitle: 'Illuminate the Space. Transform the Experience.',
      description:
        'At MME Worldwide, lighting is more than illumination. It is an essential part of the experience. Our creative lighting team combines design, technology, and production expertise to transform venues, environments, and architectural spaces into visually compelling experiences that reflect your brand and captivate your audience.<br><br>From corporate events, product launches, experiential activations, conferences, galas, fashion shows, and private celebrations to large-scale productions, we create customized lighting solutions that establish atmosphere, enhance architecture, highlight key moments, and bring every creative vision to life.<br><br>Our capabilities include architectural lighting, intelligent and moving lighting, LED systems, uplighting, stage and scenic lighting, pin spotting, custom color programming, projection and logo treatments, atmospheric effects, specialty fixtures, lighting control, rigging coordination, and full technical production.<br><br>From creative concept and lighting design through programming, installation, show operation, and strike, MME Worldwide provides a seamless end-to-end solution with meticulous attention to every detail.<br><br>We do not simply light an event. We use light to create emotion, define atmosphere, and transform the way your audience experiences the moment.',
      closer: 'Illuminate. Transform. Experience.',
      images: [
    ...
    {
      id: 'staging',
      title: 'Staging & Scenic Production',
      subtitle: 'Where Your Brand Takes Center Stage.',
      description:
        'At MME Worldwide, we design and produce staging environments that turn presentations, performances, and brand moments into powerful audience experiences. From executive conferences and product launches to experiential activations, fashion shows, galas, award ceremonies, and large-scale corporate productions, every stage is thoughtfully designed around your brand, audience, and objectives.<br><br>Our capabilities include custom stages, scenic environments, branded stage sets, presentation platforms, runways, risers, LED-integrated staging, custom backdrops, lecterns, stairs and railings, stage decking, specialty finishes, scenic fabrication, and complete technical production.<br><br>From initial creative concept and technical design through fabrication, installation, show execution, and strike, MME Worldwide provides a seamless end-to-end solution, integrating staging, lighting, audio visual, graphics, and scenic design into one cohesive environment.<br><br>Whether it is an intimate executive presentation or a global product reveal, we create stages designed to command attention, elevate your message, and make every defining moment unforgettable.',
      closer: 'Set the Stage. Elevate the Brand. Own the Moment.',
      images: [
    ...
    {
      id: 'design',
      title: 'Creative Design & Décor',
      subtitle: 'Vision. Design. Transformation.',
      description:
        'At MME Worldwide, we believe exceptional experiences begin with exceptional design. Our creative team transforms spaces into immersive environments that bring your brand, vision, and story to life.<br><br>From corporate events and experiential activations to product launches, conferences, galas, fashion events, and private celebrations, we develop distinctive design concepts that create atmosphere, inspire engagement, and leave a lasting impression.<br><br>Our creative capabilities include event design, creative direction, custom décor, scenic environments, branded installations, floral design, furniture and lounge environments, tablescapes, custom props, entrance experiences, ceiling treatments, specialty draping, dimensional branding, and immersive installations.<br><br>From the first mood board and creative concept through design development, sourcing, fabrication, installation, styling, and final execution, MME Worldwide provides a seamless creative process with meticulous attention to every detail.<br><br>Whether transforming an iconic venue, creating an immersive brand activation, or designing an environment from the ground up, we approach every project with one goal: to create a space that does not simply look extraordinary. It makes your audience feel something extraordinary.',
      closer: 'Imagine the Vision. Transform the Space. Create the Experience.',
      images: [
      ...
      imageAlts: [
        'Creative design display 1',
        'Creative design display 2',
        'Creative design display 3',
        'Creative design display 4',
        'Creative design display 5',
      ],
    },
    {
      id: 'event-props',
      title: 'Event Props & Immersive Environments',
      subtitle: 'The Details That Transform a Space Into an Experience.',
      description:
        'At MME Worldwide, our curated collection of event props and custom-designed scenic elements brings imagination to life. From sophisticated corporate events and product launches to experiential activations, themed celebrations, fashion events, galas, and holiday experiences, we provide distinctive props designed to create impact, atmosphere, and unforgettable guest moments.<br><br>Our extensive capabilities include statement props, dimensional décor, themed installations, custom-built scenic elements, branded displays, oversized objects, entrance features, photo moments, interactive installations, holiday décor, architectural elements, specialty furniture, and one-of-a-kind custom creations.<br><br>Looking for something that does not exist yet? Our creative and fabrication teams can design and build it exclusively for your brand or event, taking your vision from initial concept and rendering through fabrication, finishing, delivery, installation, and strike.<br><br>Whether you need a single statement piece or an entire immersive environment, MME Worldwide combines creative design, an extensive rental inventory, custom fabrication, and full-service production to deliver a seamless experience from beginning to end.',
      closer: 'Imagine It. Create It. Experience It.',
      images: [
      ...
      imageAlts: [
        'Event props display 1',
        'Event props display 2',
        'Event props display 3',
      ],
    },
    {
      id: 'event-rental',
      title: 'Event Rental',
      subtitle:
        'Curated Rentals. Elevated Environments. Exceptional Experiences.',
      description:
        'At MME Worldwide, our event rental collection is designed to transform ordinary spaces into extraordinary environments. From corporate events and conferences to product launches, experiential activations, galas, fashion events, weddings, and private celebrations, we provide an extensive selection of premium event rentals to complement every vision and style.<br><br>Our collection includes lounge furniture, sofas, chairs, tables, bars, bar stools, cocktail tables, dining furniture, specialty seating, staging, linens, décor, props, display elements, backdrops, red carpets, stanchions, lighting, and specialty event furnishings.<br><br>Whether you are creating an intimate executive reception, a sophisticated branded environment, or a large-scale production, our team can help curate the right pieces to create a cohesive and elevated guest experience.<br><br>Need something completely unique? MME Worldwide can combine our rental inventory with custom fabrication, branded graphics, scenic design, lighting, and décor to create an environment designed exclusively for your event.<br><br>From selection and logistics to delivery, installation, on-site coordination, and strike, our team provides a seamless rental experience from beginning to end.',
      closer: 'Curated for Your Vision. Delivered for Your Experience.',
      images: [
        '/services/production/decor/gallery-02.jpg',
        '/services/production/decor/gallery-03.jpg',
        '/services/production/design/gallery-04.jpg',
      ...
      imageAlts: [
        'Event rental display 1',
        'Event rental display 2',
        'Event rental display 3',
      ],
      link: { text: 'Browse the rental collection', url: '/rentals' },
    },
    {
      id: 'musical-entertainment',
      title: 'Musical Entertainment',
      subtitle: 'The Sound. The Energy. The Experience.',
      description:
        'At MME Worldwide, we believe music is more than entertainment. It sets the tone, creates emotion, and defines the energy of an extraordinary event. From sophisticated corporate gatherings and conferences to product launches, experiential activations, galas, fashion events, weddings, and private celebrations, we curate exceptional musical talent to complement your audience, brand, and vision.<br><br>Our entertainment portfolio includes live bands, DJs, vocalists, jazz ensembles, string quartets, pianists, acoustic performers, orchestras, specialty musicians, roaming performers, and custom musical productions. From an elegant cocktail reception to a high-energy celebration, every performance is thoughtfully selected to create the right atmosphere at the right moment.<br><br>For corporate and branded experiences, our creative team can develop custom entertainment concepts, branded performances, musical reveals, product-launch moments, and immersive entertainment experiences designed specifically around your campaign or event.<br><br>From talent selection and contracting to technical production, staging, audio, lighting, artist coordination, and show management, MME Worldwide provides one seamless entertainment solution from concept through performance.<br><br>Whether the moment calls for sophistication, excitement, or something completely unexpected, we curate entertainment that does not simply perform for your guests. It connects with them.',
      closer:
        'Curated Talent. Unforgettable Energy. Extraordinary Experiences.',
      images: [
      ...
      imageAlts: [
        'Musical entertainment display 1',
        'Musical entertainment display 2',
        'Musical entertainment display 3',
      ],
    },
    {
      id: 'entertainment-experiences',
      title: 'Entertainment & Interactive Experiences',
      subtitle:
        'Entertainment That Captivates. Experiences That Connect. Moments That Last.',
      description:
        'At MME Worldwide, we believe exceptional entertainment does more than fill a room. It creates energy, inspires interaction, and gives guests something to remember. From corporate events and experiential activations to product launches, conferences, galas, holiday celebrations, and private events, we curate live entertainment and interactive experiences tailored to your brand, audience, and vision.<br><br>Our entertainment portfolio includes specialty performers, dancers, aerialists, acrobats, cirque-style acts, magicians, mentalists, strolling performers, character entertainment, casino experiences, carnival and midway games, arcade games, sports challenges, simulators, virtual reality, team-building activities, and custom branded experiences.<br><br>Photo Booths and Social Experiences<br>Turn every guest into part of the experience with our collection of premium photo booths and interactive content activations, including 360° video booths, glam booths, AI-powered photo experiences, GIF and Boomerang stations, green-screen experiences, roaming photography, custom photo sets, branded backdrops, and immersive photo environments.<br><br>For corporate and experiential campaigns, photo experiences can be completely customized with brand graphics, digital overlays, scenic fabrication, custom props, branded content, social sharing, and personalized guest interactions, extending the experience beyond the event itself.<br><br>Casino, Carnival and Interactive Gaming<br>From the sophistication of a private casino evening to the energy of a fully immersive carnival, MME Worldwide creates complete entertainment environments featuring casino tables and professional dealers, carnival games, arcade experiences, interactive challenges, prize stations, specialty performers, and custom-designed attractions.<br><br>Whether you need a single signature activation or an entire entertainment experience, MME Worldwide manages everything from creative concept and talent sourcing to equipment, staffing, technical production, installation, show management, and strike.',
      closer:
      ...
      imageAlts: [
        'Interactive entertainment display 1',
        'Interactive entertainment display 2',
        'Interactive entertainment display 3',
      ],
    },
    {
      id: 'logistics-storage',
      title: 'Logistics, White-Glove Services & Storage',
      subtitle: 'Seamless Logistics. Exceptional Care. Flawless Execution.',
      description:
        'At MME Worldwide, exceptional events depend on what happens behind the scenes. Our comprehensive logistics and white-glove services provide brands, agencies, exhibitors, and corporate clients with a seamless solution for the transportation, handling, storage, delivery, installation, and management of event assets.<br><br>From high-value décor and custom fabrication to trade show exhibits, branded installations, production equipment, furniture, and specialty materials, every item is handled with precision and care. Our capabilities include white-glove delivery, dedicated trucking, freight coordination, receiving and inspection, inventory management, short and long term storage, warehousing, packing and crating, installation, on-site handling, strike, and return logistics.<br><br>For multi-city activations, product launches, roadshows, and recurring corporate programs, MME Worldwide can manage your assets from one event to the next, providing secure storage, inventory tracking, scheduled deployment, and coordinated transportation to help streamline operations and protect your investment.<br><br>From the warehouse to the event floor and back again, our experienced team manages every movement with one objective: your assets arrive at the right place, at the right time, in presentation-ready condition.',
      closer:
      ...
      imageAlts: [
        'Logistics and storage display 1',
        'Logistics and storage display 2',
        'Logistics and storage display 3',
      ],
    },
  ],
